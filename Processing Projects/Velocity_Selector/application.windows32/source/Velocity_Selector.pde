...
void options() {
  ...
  if(options) {
    ...
    if(!particleField) {
      ...
      rect(400, 575, 300, 70);
      fill(0, 200, 50);
      rect(525, 207.5, 50, 35);
      rect(525, 242.5, 50, 35);
      rect(525, 277.5, 50, 35);
      rect(525, 312.5, 50, 35);
      rect(525, 487.5, 50, 35);
      rect(525, 522.5, 50, 35);
      rect(525, 557.5, 50, 35);
      rect(525, 592.5, 50, 35);
      fill(200, 0, 0);
      rect(635, 65, 30, 30);
...
float findTheta(float xVel, float yVel) {
  float theta;
  if(!(xVel == 0) && xVel > 0) {
